<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="WFComments.aspx.cs" Inherits="Presentation.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <%--Id--%>
        <asp:HiddenField ID="HFCommentId" runat="server" />  <%--Permite coultar la llave primearia--%>
        <br />
        <%--Comentario--%>
        ...
        <asp:DropDownList ID="DDLClient" runat="server" OnSelectedIndexChanged="DDLClient_SelectedIndexChanged"></asp:DropDownList>
        <br />
