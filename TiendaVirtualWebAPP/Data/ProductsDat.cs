...
namespace Data
{
    public class ProductsDat
    {
        ...
        public DataSet showProducts()
        {
            ...
            objSelectCmd.CommandText = "proSelectProducto"; // Nombre del procedimiento almacenado
        ...
        public bool deleteProducts(int _idProducts)
        {
            ...
            MySqlCommand objSelectCmd = new MySqlCommand();
            objSelectCmd.Connection = objPer.openConnection();
            objSelectCmd.CommandText = "proDeleteProducto"; // Nombre del procedimiento almacenado
            objSelectCmd.CommandType = CommandType.StoredProcedure;
            objSelectCmd.Parameters.Add("v_id", MySqlDbType.Int32).Value = _idProducts;
